...
Đã có các màn: login/register, dashboard, knowledge base, campaign/plan, posts/editor/review, schedule, publishing logs, reports và integrations. Mock mode cho phép phát triển độc lập. Electron main/preload và local sidecar chưa nằm trong thư mục này.
